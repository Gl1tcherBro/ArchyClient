...
public class ArchyClientOptions extends Screen {
    ...
    protected void init() {
        ...
        rowHelper.addChild(this.editBox(AUTOGG, ArchyClient.configOptions.getAutoGG(), ArchyClient.configOptions::setAutoGG));
        rowHelper.addChild(this.actionButton(TOGGLEAUTOTPAACCEPT, ArchyClientOptions::toggleAutoTPAACCEPT));
        rowHelper.addChild(this.editBox(AUTOTPAACCEPT, ModStuffs.getListAsString(ArchyClient.configOptions.getAutoTPAACCEPT()), ModStuffs::setAutoTPAACCEPTString));
        rowHelper.addChild(this.actionButton(TOGGLEAUTOTORTURE, ArchyClientOptions::toggleAutoTorture));
        rowHelper.addChild(this.editBox(AUTOTORTURE, ModStuffs.getListAsString(ArchyClient.configOptions.getAutoTorture()), ModStuffs::setAutoTortureString));
        rowHelper.addChild(this.actionButton(TOGGLEAUTOSKIPADMIN, ArchyClientOptions::toggleAutoSkipAdmin));
        rowHelper.addChild(this.editBox(AUTOSKIPADMIN, ArchyClient.configOptions.getAutoSkipAdmin(), ArchyClient.configOptions::setAutoSkipAdmin));
    ...
    protected final EditBox editBox(Component component, String defaultVal, Consumer<String> method) {
        ArchyClientOptions screen = this;
